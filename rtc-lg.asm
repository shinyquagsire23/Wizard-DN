...
@ Modified for LeafGreen by itari
...
@ ----------------------------------------------------------------
.align 2
.UnkFunc1:		.word 0x0800B179 @ Same as FireRed
.UnkFunc2:		.word 0x08000511 @ Same as FireRed
.Return:			.word 0x080004bF @ Same again
...
updateMapPal:		.word 0x08059AD8+1 @ Same again
updateNPCPal:		.word 0x0805FECC+1 @ Same again
map:				.word 0x02036DFC
battlecheck:	     .word 0x02024018
mainloop:			.word 0x08079DE0 @ Finally a difference! (The only one!)
